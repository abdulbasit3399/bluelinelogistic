...
<div class="intro">
    ...
    <!--begin::row section video_url -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_easyship::view.video_url') </label>
        <div class="col-md-8">
            <div class="input-group url_input_container" id="url_input_container_video_url">
                <input
                    type="text"
                    name="video_url"
                    class="form-control section-title form-control-choose-type form-control-custom "
                    value="{{ isset($data['video_url']) && isset($data['video_url']) ? $data['video_url'] : '' }}"
                >
            </div>
        </div>
    </div>
    <!--end::row section video_url -->
