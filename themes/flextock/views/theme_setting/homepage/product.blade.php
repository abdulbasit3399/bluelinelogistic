...
<div class="product">
    ...
    <!--begin::row section product_main_title -->
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container" id="lang_container_section_title_left">
                ...
                <input type="text" name="product_main_title[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['product_main_title']) && isset($data['product_main_title'][app()->getLocale()]) ? $data['product_main_title'][app()->getLocale()] : 'This is the heading' }}">
                @foreach (get_langauges_except_current() as $locale)
                    <input type="text" name="product_main_title[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
                        value="{{ isset($data['product_main_title']) && isset($data['product_main_title'][$locale['code']]) ? $data['product_main_title'][$locale['code']] : 'This is the heading' }}">
                @endforeach
            </div>
    ...
    <!--end::row section product_main_title -->

    <!--begin::Input  product_main_image -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_flextock::view.main_image') </label>
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="product_main_image" data-type="image" max-items="1"
                    name="product_main_image" :model="$model" collection="product_main_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="product_main_image" data-type="image" name="product_main_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    <!--end::Input product_main_image -->



    <!--begin::Input image_1 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_flextock::view.icon') </label>
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="product_1_image" data-type="image" max-items="1"
                    name="product_1_image" :model="$model" collection="product_1_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="product_1_image" data-type="image" name="product_1_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="product_1_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['product_1_description']) && isset($data['product_1_description'][app()->getLocale()]) ? $data['product_1_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="product_1_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['product_1_description']) && isset($data['product_1_description'][$locale['code']]) ? $data['product_1_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="product_2_image" data-type="image" max-items="1"
                    name="product_2_image" :model="$model" collection="product_2_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="product_2_image" data-type="image" name="product_2_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="product_2_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['product_2_description']) && isset($data['product_2_description'][app()->getLocale()]) ? $data['product_2_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="product_2_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['product_2_description']) && isset($data['product_2_description'][$locale['code']]) ? $data['product_2_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="product_3_image" data-type="image" max-items="1"
                    name="product_3_image" :model="$model" collection="product_3_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="product_3_image" data-type="image" name="product_3_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="product_3_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['product_3_description']) && isset($data['product_3_description'][app()->getLocale()]) ? $data['product_3_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="product_3_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['product_3_description']) && isset($data['product_3_description'][$locale['code']]) ? $data['product_3_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="product_4_image" data-type="image" max-items="1"
                    name="product_4_image" :model="$model" collection="product_4_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="product_4_image" data-type="image" name="product_4_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="product_4_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['product_4_description']) && isset($data['product_4_description'][app()->getLocale()]) ? $data['product_4_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="product_4_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['product_4_description']) && isset($data['product_4_description'][$locale['code']]) ? $data['product_4_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container" id="lang_container_section_button">
                ...
                <input type="text" name="section_button[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['section_button']) && isset($data['section_button'][app()->getLocale()]) ? $data['section_button'][app()->getLocale()] : 'Button' }}">
                @foreach (get_langauges_except_current() as $locale)
                    <input type="text" name="section_button[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
