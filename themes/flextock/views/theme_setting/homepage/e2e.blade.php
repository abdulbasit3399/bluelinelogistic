...
<div class="e2e">
    ...
    <!--begin::row min_title_color -->
    <div class="row mb-6 text_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_flextock::view.min_title_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
                    class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} text_color_input"
                    name="min_title_color"
                    value="{{ isset($data['min_title_color']) ? $data['min_title_color'] :   ''   }}"
                >
            </div>
        </div>
    </div>
    <!--end::row min_title_color -->
    ...
    <!--begin::row section e2e_main_title -->
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_title_left">
                    ...
                    <input
                        type="text"
                        name="e2e_main_title[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['e2e_main_title']) && isset($data['e2e_main_title'][app()->getLocale()]) ? $data['e2e_main_title'][app()->getLocale()] : 'This is the heading' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="e2e_main_title[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['e2e_main_title']) && isset($data['e2e_main_title'][$locale['code']]) ? $data['e2e_main_title'][$locale['code']] : 'This is the heading' }}"
                        >
                    @endforeach
                </div>
    ...
    <!--end::row section e2e_main_title -->
    ...
    <!--begin::Input image_1 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_flextock::view.section_banner_1') </label>
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="e2e_1_image" data-type="image" max-items="1" name="e2e_1_image" :model="$model" collection="e2e_1_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="e2e_1_image" data-type="image" name="e2e_1_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input image_1 -->
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_title_left">
                    ...
                    <input
                        type="text"
                        name="e2e_1_title[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['e2e_1_title']) && isset($data['e2e_1_title'][app()->getLocale()]) ? $data['e2e_1_title'][app()->getLocale()] : 'This is sub heading' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="e2e_1_title[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['e2e_1_title']) && isset($data['e2e_1_title'][$locale['code']]) ? $data['e2e_1_title'][$locale['code']] : 'This is sub heading' }}"
                        >
                    @endforeach
                </div>
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                <select class="change_language form-control form-control-sm badge badge-light fw-bold py-4 px-3 ">
                    ...
                    <textarea name="e2e_1_description[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['e2e_1_description']) && isset($data['e2e_1_description'][app()->getLocale()]) ? $data['e2e_1_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @foreach(get_langauges_except_current() as $locale)
                        <textarea name="e2e_1_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['e2e_1_description']) && isset($data['e2e_1_description'][$locale['code']]) ? $data['e2e_1_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <!--begin::Input image_2 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_flextock::view.section_banner_2') </label>
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="e2e_2_image" data-type="image" max-items="1" name="e2e_2_image" :model="$model" collection="e2e_2_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="e2e_2_image" data-type="image" name="e2e_2_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input image_2 -->
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_title_left">
                    ...
                    <input
                        type="text"
                        name="e2e_2_title[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['e2e_2_title']) && isset($data['e2e_2_title'][app()->getLocale()]) ? $data['e2e_2_title'][app()->getLocale()] : 'This is sub heading' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="e2e_2_title[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['e2e_2_title']) && isset($data['e2e_2_title'][$locale['code']]) ? $data['e2e_2_title'][$locale['code']] : 'This is sub heading' }}"
                        >
                    @endforeach
                </div>
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                <select class="change_language form-control form-control-sm badge badge-light fw-bold py-4 px-3 ">
                    ...
                    <textarea name="e2e_2_description[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['e2e_2_description']) && isset($data['e2e_2_description'][app()->getLocale()]) ? $data['e2e_2_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @foreach(get_langauges_except_current() as $locale)
                        <textarea name="e2e_2_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['e2e_2_description']) && isset($data['e2e_2_description'][$locale['code']]) ? $data['e2e_2_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <!--begin::Input image_3 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_flextock::view.section_banner_3') </label>
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="e2e_3_image" data-type="image" max-items="1" name="e2e_3_image" :model="$model" collection="e2e_3_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="e2e_3_image" data-type="image" name="e2e_3_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input image_3 -->
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_title_left">
                    ...
                    <input
                        type="text"
                        name="e2e_3_title[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['e2e_3_title']) && isset($data['e2e_3_title'][app()->getLocale()]) ? $data['e2e_3_title'][app()->getLocale()] : 'This is sub heading' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="e2e_3_title[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['e2e_3_title']) && isset($data['e2e_3_title'][$locale['code']]) ? $data['e2e_3_title'][$locale['code']] : 'This is sub heading' }}"
                        >
                    @endforeach
                </div>
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                <select class="change_language form-control form-control-sm badge badge-light fw-bold py-4 px-3 ">
                    ...
                    <textarea name="e2e_3_description[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['e2e_3_description']) && isset($data['e2e_3_description'][app()->getLocale()]) ? $data['e2e_3_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @foreach(get_langauges_except_current() as $locale)
                        <textarea name="e2e_3_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['e2e_3_description']) && isset($data['e2e_3_description'][$locale['code']]) ? $data['e2e_3_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <!--begin::Input image_4 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_flextock::view.section_banner_4') </label>
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="e2e_4_image" data-type="image" max-items="1" name="e2e_4_image" :model="$model" collection="e2e_4_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="e2e_4_image" data-type="image" name="e2e_4_image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input image_4 -->
    ...
    <!--begin::row title_4 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_flextock::view.title_4') </label>
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_title_left">
                    ...
                    <input
                        type="text"
                        name="e2e_4_title[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['e2e_4_title']) && isset($data['e2e_4_title'][app()->getLocale()]) ? $data['e2e_4_title'][app()->getLocale()] : 'This is sub heading' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="e2e_4_title[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['e2e_4_title']) && isset($data['e2e_4_title'][$locale['code']]) ? $data['e2e_4_title'][$locale['code']] : 'This is sub heading' }}"
                        >
                    @endforeach
                </div>
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_flextock::view.Description_4') </label>
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                <select class="change_language form-control form-control-sm badge badge-light fw-bold py-4 px-3 ">
                    ...
                    <textarea name="e2e_4_description[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['e2e_4_description']) && isset($data['e2e_4_description'][app()->getLocale()]) ? $data['e2e_4_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @foreach(get_langauges_except_current() as $locale)
                        <textarea name="e2e_4_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['e2e_4_description']) && isset($data['e2e_4_description'][$locale['code']]) ? $data['e2e_4_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
    <!--end::row description_4 -->
        ...
        <div class="row mb-6">
            <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_flextock::view.text_button') </label>
            <div class="col-md-8">
        ...
        <div class="row mb-6">
            <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_flextock::view.section_url_url') </label>
            <div class="col-md-8">
