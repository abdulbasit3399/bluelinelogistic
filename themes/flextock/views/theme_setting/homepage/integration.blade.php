...
<div class="integration">
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container" id="lang_container_section_title_left">
                ...
                <input type="text" name="integration_main_title[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['integration_main_title']) && isset($data['integration_main_title'][app()->getLocale()]) ? $data['integration_main_title'][app()->getLocale()] : 'This is the heading' }}">
                @foreach (get_langauges_except_current() as $locale)
                    <input type="text" name="integration_main_title[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
                        value="{{ isset($data['integration_main_title']) && isset($data['integration_main_title'][$locale['code']]) ? $data['integration_main_title'][$locale['code']] : 'This is the heading' }}">
                @endforeach
            </div>
    ...
    <!--end::row section main_title -->

    <!--begin::row description -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_flextock::view.main_description') </label>
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="integration_main_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['integration_main_description']) && isset($data['integration_main_description'][app()->getLocale()]) ? $data['integration_main_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="integration_main_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['integration_main_description']) && isset($data['integration_main_description'][$locale['code']]) ? $data['integration_main_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="integration_1_image" data-type="image" max-items="1"
                    name="integration_1_image" :model="$model" collection="integration_1_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="integration_1_image" data-type="image" name="integration_1_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="integration_2_image" data-type="image" max-items="1"
                    name="integration_2_image" :model="$model" collection="integration_2_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="integration_2_image" data-type="image" name="integration_2_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="integration_3_image" data-type="image" max-items="1"
                    name="integration_3_image" :model="$model" collection="integration_3_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="integration_3_image" data-type="image" name="integration_3_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="integration_4_image" data-type="image" max-items="1"
                    name="integration_4_image" :model="$model" collection="integration_4_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="integration_4_image" data-type="image" name="integration_4_image"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
