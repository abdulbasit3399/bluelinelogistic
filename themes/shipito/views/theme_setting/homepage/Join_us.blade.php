...
<div class="info">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold required fs-6 d-inline-flex align-items-center"> @lang('theme_easyship::view.section_title') </label>
        <div class="col-md-8">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold required fs-6 d-inline-flex align-items-center"> @lang('theme_easyship::view.section_description') </label>
        <div class="col-md-8">
    ...
    <!--begin::section Image -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_easyship::view.image_place') </label>
        <div class="col-md-8">
            <select
                class="form-control"
                ...
                name="image_place"
            >
                @foreach(config('theme_easyship.image_place') as $key => $name)
                    <option value="{{ $key }}" {{ isset($data['image_place']) && $data['image_place'] == $key ? 'selected="selected"' : '' }}>{{$name}}</option>
                @endforeach
            </select>
        </div>
    </div>
