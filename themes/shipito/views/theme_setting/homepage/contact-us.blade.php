<div class="hero">
    ...
    <div class="row mb-6 button_bg_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_shipito::view.button_bg_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
    ...
    <div class="row mb-6 button_text_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_shipito::view.section_button_text_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
    ...
    <!--begin::row section title  1-->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_shipito::view.title_1') </label>
        <div class="col-md-8">

            <div class="input-group lang_container" id="lang_container_contact_1_title">
                <select
                ...
                <input type="text" name="contact_1_title[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['contact_1_title']) && isset($data['contact_1_title'][app()->getLocale()]) ? $data['contact_1_title'][app()->getLocale()] : 'This is sub heading' }}">
                @foreach (get_langauges_except_current() as $locale)
                    <input type="text" name="contact_1_title[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
                        value="{{ isset($data['contact_1_title']) && isset($data['contact_1_title'][$locale['code']]) ? $data['contact_1_title'][$locale['code']] : 'This is sub heading' }}">
                @endforeach
            </div>
    ...
    <!--end::row section title 1 -->


    <!--begin::row section title  2 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_shipito::view.title_2') </label>
        <div class="col-md-8">
            ...
            <div class="input-group lang_container" id="lang_container_section_title">
                ...
                <input type="text" name="contact_2_title[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['contact_2_title']) && isset($data['contact_2_title'][app()->getLocale()]) ? $data['contact_2_title'][app()->getLocale()] : 'This is sub heading' }}">
                @foreach (get_langauges_except_current() as $locale)
                    <input type="text" name="contact_2_title[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
                        value="{{ isset($data['contact_2_title']) && isset($data['contact_2_title'][$locale['code']]) ? $data['contact_2_title'][$locale['code']] : 'This is sub heading' }}">
                @endforeach
            </div>
    ...
    <!--end::row section title 2 -->


    <!--begin::row section button -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_shipito::view.section_button') </label>
        <div class="col-md-8">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_shipito::view.section_url') </label>
        <div class="col-md-8">
            ...
            <div class="input-group url_input_container" id="url_input_container_section_url">
                <select
                    ...
                    data-type="array" name="section_url[type]" data-title="type">
                    <option value="custom"
                        {{ isset($data['section_url']) && isset($data['section_url']['type']) ? ($data['section_url']['type'] == 'custom' ? 'selected' : '') : 'selected' }}>
                        @lang('theme_shipito::view.custom')</option>
                    @if (check_module('pages'))
                        <option value="page"
                            {{ isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'page' ? 'selected' : '' }}>
                            @lang('theme_shipito::view.page')</option>
                    @endif
                    @if (check_module('blog'))
                        <option value="category"
                            {{ isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'category' ? 'selected' : '' }}>
                            @lang('theme_shipito::view.category')</option>
                        <option value="post"
                            {{ isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'post' ? 'selected' : '' }}>
                            @lang('theme_shipito::view.post')</option>
                    @endif
                </select>
                <input type="text" name="section_url[custom]" data-title="custom" data-type="array"
                ...
                @if (check_module('pages'))
                    <div
                        class="form-control-choose-type form-control-page {{ isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'page' ? '' : 'd-none' }}">
                        <select class="form-select mw-auto" name="section_url[page]" data-title="page" data-type="array"
                            data-placeholder="@lang('theme_shipito::view.choose_page')">
                            @if (isset($id) && isset($data['categories']) && is_array($data['categories']))
                                ...
                                @foreach ($data['categories'] as $categoryId)
                                    ...
                                    <option value="{{ $category->id }}"
                                        {{ isset($data['section_url']) && isset($data['section_url']['page']) && $data['section_url']['page'] == $category->id ? 'selected' : '' }}>
                ...
                @if (check_module('blog'))
                    <div
                        class="form-control-choose-type form-control-category {{ isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'category' ? '' : 'd-none' }}">
                        <select class="form-select  mw-auto " name="section_url[category]" data-title="category"
                            data-type="array" data-placeholder="@lang('theme_shipito::view.choose_category')">
                            @if (isset($id) && isset($data['categories']) && is_array($data['categories']))
                    ...
                    <div
                        class="form-control-choose-type form-control-post {{ isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'post' ? '' : 'd-none' }}">
                        <select class="form-select mw-auto " name="section_url[post]" data-title="post"
                            data-type="array" data-placeholder="@lang('theme_shipito::view.choose_post')">
                            @if (isset($id) && isset($data['categories']) && is_array($data['categories']))
