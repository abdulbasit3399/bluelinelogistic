<div class="hero">
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="works_1_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['works_1_description']) && isset($data['works_1_description'][app()->getLocale()]) ? $data['works_1_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="works_1_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['works_1_description']) && isset($data['works_1_description'][$locale['code']]) ? $data['works_1_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            @if (isset($model))
                <x-media-library-collection data-title="works_1_img" data-type="image" max-items="1" name="works_1_img" :model="$model" collection="section_banner" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="works_1_img" data-type="image" name="works_1_img" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="works_2_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['works_2_description']) && isset($data['works_2_description'][app()->getLocale()]) ? $data['works_2_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="works_2_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['works_2_description']) && isset($data['works_2_description'][$locale['code']]) ? $data['works_2_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="works_3_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['works_3_description']) && isset($data['works_3_description'][app()->getLocale()]) ? $data['works_3_description'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="works_3_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['works_3_description']) && isset($data['works_3_description'][$locale['code']]) ? $data['works_3_description'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            @if (isset($model))
                <x-media-library-collection data-title="works_2_img" data-type="image" max-items="1" name="works_2_img" :model="$model" collection="section_banner" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="works_2_img" data-type="image" name="works_2_img" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
