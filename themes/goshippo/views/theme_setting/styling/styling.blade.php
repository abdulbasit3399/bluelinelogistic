<div class="styling-setting">
    ...
    <div class="setting-box">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.colors') </h4>
        <!--begin::row main_color -->
        <div class="row mb-6 main_color">
            <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.main_color') </label>
            <div class="col-md-8">
        ...
        <div class="row mb-6 secondary_color">
            <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.secondary_color') </label>
            <div class="col-md-8">
                <div class="input-group">
                    <input
    ...
    <!--begin::fonts -->
    <div class="setting-box">
        {{-- <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.fonts') </h4> --}}
