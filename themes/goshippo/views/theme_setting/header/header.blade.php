<div class="header-setting">
    ...
    <div class="setting-box">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.header_contanier') </h4>
        <!--begin::setting-boxs -->
        <div class="setting-boxs">

            <!--begin::row header_style -->
            <div class="row mb-6 header_style">
                <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.header_style') </label>
                <div class="col-md-8">
            ...
            <div class="row mb-6 header_logo">
                <label class="col-md-4 col-form-label fw-bold fs-6">@lang('theme_goshippo::view.header_logo')</label>
                <div class="col-md-8">
            ...
            <div class="row mb-6 display_language_switcher">
                <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.display_language_switcher') </label>
                <div class="col-md-8">
    ...
    <div class="setting-box">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.horizontal_menu') </h4>
        <!--begin::setting-boxs -->
        <div class="setting-boxs last">
            <!--begin::row display_home_icon -->
            <div class="row mb-6 display_home_icon">
                <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_home_link') </label>
                <div class="col-md-8">
                    <div class="custom-control custom-switch  form-check form-switch">
                        <input
            ...
            <div class="row mb-6 display_sign_in">
                <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_sign_in') </label>
                <div class="col-md-8">
                    <div class="custom-control custom-switch  form-check form-switch">
                        <input
            ...
            <div class="row mb-6 display_tracking_search">
                <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_tracking_search') </label>
                <div class="col-md-8">
                    <div class="custom-control custom-switch  form-check form-switch">
                        <input
