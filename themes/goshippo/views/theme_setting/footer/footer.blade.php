...
<div class="footer-setting">
    ...
    <div class="setting-box">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.main_footer') </h4>

        <!--begin::row display_footer -->
        <div class="row mb-6 display_footer">
            <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_footer') </label>
            <div class="col-md-8">
        ...
        <div class="footer_control" style="{{ isset($data['display_footer']) && $data['display_footer'] ?: 'display: none;' }}">
            ...
            <div class="row mb-6 footer_style">
                <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.footer_style') </label>
                <div class="col-md-8">
                    <div class="input-group">
                        <div class="form-check mx-3">
                            ...
                            <label class="custom-control-label form-check-label" for="footer_light_style">
                                @lang('theme_goshippo::view.light')
                            </label>
                        </div>
                        <div class="form-check mx-3">
                            <input
    ...
    <div class="setting-box footer_control" style="{{ isset($data['display_footer']) && $data['display_footer'] ?: 'display: none;' }}">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.footer_widgets') </h4>

        <!--begin::row display_widgets -->
        <div class="row mb-6 display_widgets">
            <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_widgets') </label>
            <div class="col-md-8">
                <div class="custom-control custom-switch form-check form-switch">
                    <input
        ...
        <div class="widgets_control" style="{{ isset($data['display_widgets']) && $data['display_widgets'] ?: 'display: none;' }}">
            <div class="row mb-6 widgets_count">
                <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.widgets_count') </label>
                <div class="col-md-8">
                    <div class="input-group">
                        <div class="form-check mx-3">
    ...
    <div class="setting-box footer_control" style="{{ isset($data['display_footer']) && $data['display_footer'] ?: 'display: none;' }}">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.footer_copyright') </h4>
        <!--begin::row display_copyright -->
        <div class="row mb-6 display_copyright">
            <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_copyright') </label>
            <div class="col-md-8">
                <div class="custom-control custom-switch form-check form-switch">
                    <input
        ...
        <div class="copyright_control" style="{{ isset($data['display_copyright']) && $data['display_copyright'] ?: 'display: none;' }}">
            ...
            <!--begin::row copyright -->
            <div class="row mb-6">
                <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.copyright') </label>
                <div class="col-md-8">
                    <div class="input-group">
                        <textarea
                            name="copyright"
                            placeholder="@lang('theme_goshippo::view.copyright')"
                            class="form-control min-h-100px copyright_input"
                        >{{ isset($data['copyright']) ? $data['copyright'] : '' }}</textarea>
                    </div>
                    <div class="form-text">@lang('theme_goshippo::view.hint_copyright')</div>
                </div>
            </div>
            <!--end::row copyright -->
            ...
            <div class="row mb-6 display_footer_links">
                <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_footer_links') </label>
                <div class="col-md-8">
                    <div class="custom-control custom-switch form-check form-switch">
                        <input
        ...
        <div class="row mb-6 display_social">
            <label class="col-md-4 fw-bold fs-6 required"> @lang('theme_goshippo::view.display_social') </label>
            <div class="col-md-8">
                <div class="custom-control custom-switch form-check form-switch">
                    <input
        ...
        <div class="social_links" style="{{ isset($data['display_social']) && $data['display_social'] ?: 'display: none;' }}">
            ...
            <div class="row mb-6">
                <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_goshippo::view.facebook_url') </label>
                <div class="col-md-8">
            ...
            <div class="row mb-6">
                <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_goshippo::view.twitter_url') </label>
                <div class="col-md-8">
            ...
            <div class="row mb-6">
                <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_goshippo::view.google_url') </label>
                <div class="col-md-8">
            ...
            <div class="row mb-6">
                <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_goshippo::view.dribbble_url') </label>
                <div class="col-md-8">
            ...
            <div class="row mb-6">
                <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_goshippo::view.youtube_url') </label>
                <div class="col-md-8">
