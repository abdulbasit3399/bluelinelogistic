<div class="demos-setting">
    ...
    <div class="setting-box">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_goshippo::view.choose_demo') </h4>
                    ...
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.main_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.easyship_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.flextock_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.goshippo_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.qwintry_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.shipito_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_goshippo::view.timeglobalshipping_demo')
                            </div>
                        </label>
                    </div>
                </div>
