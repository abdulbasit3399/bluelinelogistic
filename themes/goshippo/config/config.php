    ...
    'theme_setting' => [
        'homepage' => [ // tab
            ...
            'sections' => [
                ...
                'partners' => [
                    'name' => __('theme_goshippo::view.partners'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'brands' => [
                    'name' => __('theme_goshippo::view.brands'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'testimonials' => [
                    'name' => __('theme_goshippo::view.theme_settings.testimonials'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
        ...
        'additional_css' => [ // tab
            'name' => __('theme_goshippo::view.theme_settings.additional_css'),
            'sections' => [
                'additional_css' => [
                    'validation' => [
                        'rules' => [
