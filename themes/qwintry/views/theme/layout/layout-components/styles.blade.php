...
//  default colore : #ae29d4 ;
$color = array_key_exists('main_color', $data) && $data['main_color'] ? " {$data['main_color']} !important;" : '#ae29d4 !important; ';
@endphp

    <link rel="stylesheet" id="kolyoum-default-css" href="{{ asset('themes/easyship/assets/css/post.style.css') }}" type="text/css" media="all" />
    <link rel="stylesheet" id="kolyoum-default-css" href="{{ asset('themes/qwintry/assets/css/post.style.css') }}" type="text/css" media="all" />
