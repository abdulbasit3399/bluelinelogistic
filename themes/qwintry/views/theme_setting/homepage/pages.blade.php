<div class="pages">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_title">
                    <select class="change_language form-control form-control-sm badge badge-light fw-bold py-4 px-3 mw-100px">
                        ...
                        <input type="text" name="section_title[{{app()->getLocale()}}]"title="{{app()->getLocale()}}" class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}" value="{{ isset($data['section_title']) && isset($data['section_title'][app()->getLocale()]) ? $data['section_title'][app()->getLocale()] : 'This is the heading' }}">
                    @foreach(Config::get('langauges_except_current') as $locale)
                        <input type="text" name="section_title[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none" value="{{ isset($data['section_title']) && isset($data['section_title'][$locale['code']]) ? $data['section_title'][$locale['code']] : 'This is the heading' }}" >
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_button">
                    ...
                    <input type="text" name="section_button[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}" value="{{ isset($data['section_button']) && isset($data['section_button'][app()->getLocale()]) ? $data['section_button'][app()->getLocale()] : 'Button' }}" >
                    @foreach(Config::get('langauges_except_current') as $locale)
                        <input type="text" name="section_button[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none" value="{{ isset($data['section_button']) && isset($data['section_button'][$locale['code']]) ? $data['section_button'][$locale['code']] : 'Button' }}" >
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="section_pages1" data-type="image" max-items="1" name="section_pages1" :model="$model" collection="section_pages1" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="section_pages1" data-type="image" name="section_pages1" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input Image -->
        ...
        <div class="col-md-8">
                <div class="input-group lang_container" id="lang_container_section_title">
                    <select class="change_language form-control form-control-sm badge badge-light fw-bold py-4 px-3 mw-100px">
                        ...
                        <input type="text" name="section_title1[{{app()->getLocale()}}]"title="{{app()->getLocale()}}" class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}" value="{{ isset($data['section_title1']) && isset($data['section_title1'][app()->getLocale()]) ? $data['section_title1'][app()->getLocale()] : 'This is the heading' }}">
                    @foreach(Config::get('langauges_except_current') as $locale)
                        <input type="text" name="section_title1[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none" value="{{ isset($data['section_title1']) && isset($data['section_title1'][$locale['code']]) ? $data['section_title1'][$locale['code']] : 'This is the heading' }}" >
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container text" id="lang_container_section_description">
                    ...
                    <textarea name="section_description1[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['section_description1']) && isset($data['section_description1'][app()->getLocale()]) ? $data['section_description1'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                    @foreach(Config::get('langauges_except_current') as $locale)
                        <textarea name="section_description1[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['section_description1']) && isset($data['section_description1'][$locale['code']]) ? $data['section_description1'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_button">
                    ...
                    <input type="text" name="section_2_button[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}" value="{{ isset($data['section_2_button']) && isset($data['section_2_button'][app()->getLocale()]) ? $data['section_2_button'][app()->getLocale()] : 'Button' }}" >
                    @foreach(Config::get('langauges_except_current') as $locale)
                        <input type="text" name="section_2_button[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none" value="{{ isset($data['section_2_button']) && isset($data['section_2_button'][$locale['code']]) ? $data['section_2_button'][$locale['code']] : 'Button' }}" >
                    @endforeach
                </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
                ...
                <div class="input-group url_input_container" id="url_input_container_section_url">
                    <select class="change_url_type form-control form-control-sm badge badge-light fw-bold py-4 px-3 mw-100px" data-type="array" name="section_2_url[type]" data-title="type">
                        <option value="custom"  {{ (isset($data['section_2_url']) && isset($data['section_2_url']['type'])) ? ($data['section_2_url']['type'] == 'custom' ? 'selected' : '') : 'selected' }}>@lang('theme_easyship::view.custom')</option>
                        @if (check_module('pages'))
                            <option value="page" {{ (isset($data['section_2_url']) && isset($data['section_2_url']['type']) && $data['section_2_url']['type'] == 'page') ? 'selected' : '' }}>@lang('theme_easyship::view.page')</option>
                        @endif
                        @if (check_module('blog'))
                            <option value="category" {{ (isset($data['section_2_url']) && isset($data['section_2_url']['type']) && $data['section_2_url']['type'] == 'category') ? 'selected' : '' }}>@lang('theme_easyship::view.category')</option>
                            <option value="post" {{ (isset($data['section_2_url']) && isset($data['section_2_url']['type']) && $data['section_2_url']['type'] == 'post') ? 'selected' : '' }}>@lang('theme_easyship::view.post')</option>
                        @endif
                    </select>
                    <input
                        type="text"
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="section_pages2" data-type="image" max-items="1" name="section_pages2" :model="$model" collection="section_pages2" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="section_pages2" data-type="image" name="section_pages2" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input Image -->
