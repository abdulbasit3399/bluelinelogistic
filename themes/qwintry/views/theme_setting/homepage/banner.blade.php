<div class="banner">
    ...
    <div class="row mb-6 button_bg_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_qwintry::view.button_bg_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} button_bg_color_input" name="button_bg_color"value="{{ isset($data['button_bg_color']) ? $data['button_bg_color'] :   ''   }}" >
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6 button_text_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_qwintry::view.section_button_text_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} button_text_color_input" name="button_text_color" value="{{ isset($data['button_text_color']) ? $data['button_text_color'] :   'white'   }}" >
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_qwintry::view.section_title') </label>
        <div class="col-md-8">
    ...
    <!--begin::row section description -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_qwintry::view.section_description_button') </label>
        <div class="col-md-8">
                <div class="input-group lang_container text" id="lang_container_section_description2">
                    ...
                    <textarea name="section_description2[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['section_description2']) && isset($data['section_description2'][app()->getLocale()]) ? $data['section_description2'][app()->getLocale()] : 'No credit card required. Cancel anytime.' }}</textarea>
                    @foreach(Config::get('langauges_except_current') as $locale)
                        <textarea name="section_description2[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['section_description2']) && isset($data['section_description2'][$locale['code']]) ? $data['section_description2'][$locale['code']] : 'No credit card required. Cancel anytime.' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_qwintry::view.section_button') </label>
        <div class="col-md-8">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_qwintry::view.section_url') </label>
        <div class="col-md-8">
                <div class="input-group url_input_container" id="url_input_container_section_url">
                    <select class="change_url_type form-control form-control-sm badge badge-light fw-bold py-4 px-3 mw-100px" data-type="array" name="section_url[type]" data-title="type">
                        <option value="custom"  {{ (isset($data['section_url']) && isset($data['section_url']['type'])) ? ($data['section_url']['type'] == 'custom' ? 'selected' : '') : 'selected' }}>@lang('theme_qwintry::view.custom')</option>
                        @if (check_module('pages'))
                            <option value="page" {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'page') ? 'selected' : '' }}>@lang('theme_qwintry::view.page')</option>
                        @endif
                        @if (check_module('blog'))
                            <option value="category" {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'category') ? 'selected' : '' }}>@lang('theme_qwintry::view.category')</option>
                            <option value="post" {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'post') ? 'selected' : '' }}>@lang('theme_qwintry::view.post')</option>
                        @endif
                    </select>
                    <input
                        type="text"
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            @if(isset($model))
                <x-media-library-collection data-title="section_1_banner" data-type="image" max-items="1" name="section_1_banner" :model="$model" collection="section_1_banner" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="section_1_banner" data-type="image" name="section_1_banner" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
        </div>
    </div>
    <!--end::Input Image -->
