<div class="globus">
    ...
    {{-- <div class="row mb-6 typer_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_easyship::view.section_typer_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} typer_color_input"name="typer_color"value="{{ isset($data['typer_color']) ? $data['typer_color'] :   ''   }}">
            </div>
        </div>
    </div> --}}
    <!--end::row typer_color -->
    ...
    <div class="row mb-6 text_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_easyship::view.section_description_color') </label>
        <div class="col-md-8">
            <div class="input-group">
    ...
    <div class="row mb-6 button_text_color">
        ...
        <div class="col-md-8">
            <div class="input-group">
                <input class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} button_text_color_input" name="button_text_color" value="{{ isset($data['button_text_color']) ? $data['button_text_color'] :   ''   }}" >
            </div>
        </div>
    </div>
