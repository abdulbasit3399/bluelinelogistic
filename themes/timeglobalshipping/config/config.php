...
$dir_images = 'theme_timeglobalshipping_images';
...
return [
    ...
    'posts_order' => [
        'latest' => __('theme_timeglobalshipping::view.latest'),
        'most_commented' => __('theme_timeglobalshipping::view.most_commented'),
        'random' => __('theme_timeglobalshipping::view.random'),
    ],

    'image_place' => [
        'start' => __('theme_timeglobalshipping::view.start'),
        'end' => __('theme_timeglobalshipping::view.end'),
    ],

    'ad_types' => [
        'html' => __('theme_timeglobalshipping::view.html'),
        'image' => __('theme_timeglobalshipping::view.image'),
        'category' => __('theme_timeglobalshipping::view.category'),
        'post' => __('theme_timeglobalshipping::view.post'),
        'tag' => __('theme_timeglobalshipping::view.tag'),
    ],

    'container_width' => [
        'full_width' => __('theme_timeglobalshipping::view.full_width'),
        'half_width' => __('theme_flextock::view.half_width'),
        'two_thirds' => __('theme_timeglobalshipping::view.two_thirds'),
        'one_third' => __('theme_timeglobalshipping::view.one_third'),
    ],


    'theme_setting' => [
        'homepage' => [ // tab
            'name' => __('theme_timeglobalshipping::view.theme_settings.homepage'),
            'sortable' => true,
            'sections' => [

                'hero' => [
                    'name' => __('theme_timeglobalshipping::view.hero'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'send' => [
                    'name' => __('theme_timeglobalshipping::view.send'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'why-us' => [
                    'name' => __('theme_timeglobalshipping::view.why-us'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'industries' => [
                    'name' => __('theme_timeglobalshipping::view.industries'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'help' => [
                    'name' => __('theme_timeglobalshipping::view.help'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'contact-us' => [
                    'name' => __('theme_timeglobalshipping::view.contact-us'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'features' => [
                    'name' => __('theme_timeglobalshipping::view.features'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
        ...
        'header' => [ // tab
            'name' => __('theme_timeglobalshipping::view.theme_settings.header'),
            'sortable' => false,
            'sections' => [
                'header' => [
                    'validation' => [
        ...
        'footer' => [ // tab
            'name' => __('theme_timeglobalshipping::view.theme_settings.footer'),
            'sections' => [
                'footer' => [
                    'validation' => [
                        'rules' => [
        ...
        'styling' => [ // tab
            'name' => __('theme_timeglobalshipping::view.theme_settings.styling'),
            'sections' => [
                'styling' => [
                    'validation' => [
                        'rules' => [
        ...
        // 'demos' => [ // tab
        //     'name' => __('theme_timeglobalshipping::view.theme_settings.demos'),
        //     'sections' => [
        //         'demos' => [
        //             'validation' => [
        //                 'rules' => [
        ...
        'additional_css' => [ // tab
            'name' => __('theme_timeglobalshipping::view.theme_settings.additional_css'),
            'sections' => [
                'additional_css' => [
                    'validation' => [
                        'rules' => [
