<div class="why-us">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center">
            @lang('theme_timeglobalshipping::view.section_description') </label>
        <div class="col-md-8">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center">
            @lang('theme_timeglobalshipping::view.section_banner') </label>
        <div class="col-md-8">
            @if (isset($model))
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container" id="lang_container_section_subtitle1">
                ...
                <input type="text" name="title_4_whyus[{{ app()->getLocale() }}]"
                    title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['title_4_whyus']) && isset($data['title_4_whyus'][app()->getLocale()]) ? $data['title_4_whyus'][app()->getLocale()] : 'This is the heading' }}">
                @foreach (get_langauges_except_current() as $locale)
                    <input type="text" name="title_4_whyus[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
                        value="{{ isset($data['title_4_whyus']) && isset($data['title_4_whyus'][$locale['code']]) ? $data['title_4_whyus'][$locale['code']] : 'This is the heading' }}">
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="description_4_whyus[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['description_4_whyus']) && isset($data['description_4_whyus'][app()->getLocale()]) ? $data['description_4_whyus'][app()->getLocale()] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @foreach (get_langauges_except_current() as $locale)
                    <textarea name="description_4_whyus[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['description_4_whyus']) && isset($data['description_4_whyus'][$locale['code']]) ? $data['description_4_whyus'][$locale['code']] : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo .' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            @if (isset($model))
                <x-media-library-collection data-title="section_banner_4_whyus" data-type="image" max-items="1"
                    name="section_banner_4_whyus" :model="$model" collection="section_banner"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="section_banner_4_whyus" data-type="image"
                    name="section_banner_4_whyus" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
