...
<div class="contact-us">
    ...
    <div class="row mb-6 text_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_timeglobalshipping::view.section_text_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
    ...
    <div class="row mb-6 button_bg_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_timeglobalshipping::view.button_bg_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
    ...
    <div class="row mb-6 button_text_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_timeglobalshipping::view.section_button_text_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
    ...
    <!--end::row section description1 -->
        ...
        <!--begin::row section phone -->
        <div class="row mb-6">
            <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_timeglobalshipping::view.phone') </label>
            <div class="col-md-8">
                    ...
                    <div class="input-group lang_container" id="lang_container_section_button">
                        ...
                        <input
                            type="text"
                            name="phone[{{app()->getLocale()}}]"
                            title="{{app()->getLocale()}}"
                            class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                            value="{{ isset($data['phone']) && isset($data['phone'][app()->getLocale()]) ? $data['phone'][app()->getLocale()] : '+971 4325 48 78' }}"
                        >
                        @foreach(get_langauges_except_current() as $locale)
                            <input
                                type="text"
                                name="phone[{{ $locale['code'] }}]"
                                title="{{ $locale['code'] }}"
                                class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                                value="{{ isset($data['phone']) && isset($data['phone'][$locale['code']]) ? $data['phone'][$locale['code']] : '+971 4325 48 78' }}"
                            >
                        @endforeach
                    </div>
            </div>
        </div>
        <!--end::row section phone -->


    <!--begin::row section button -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_timeglobalshipping::view.section_button') </label>
        <div class="col-md-8">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_timeglobalshipping::view.section_url_URL') </label>
        <div class="col-md-8">
                ...
                <div class="input-group url_input_container" id="url_input_container_section_url">
                    <select class="change_url_type form-control form-control-sm badge badge-light fw-bold py-4 px-3 mw-100px" data-type="array" name="section_url[type]" data-title="type">
                        <option value="custom"  {{ (isset($data['section_url']) && isset($data['section_url']['type'])) ? ($data['section_url']['type'] == 'custom' ? 'selected' : '') : 'selected' }}>@lang('theme_timeglobalshipping::view.custom')</option>
                        @if (check_module('pages'))
                            <option value="page" {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'page') ? 'selected' : '' }}>@lang('theme_timeglobalshipping::view.page')</option>
                        @endif
                        @if (check_module('blog'))
                            <option value="category" {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'category') ? 'selected' : '' }}>@lang('theme_timeglobalshipping::view.category')</option>
                            <option value="post" {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'post') ? 'selected' : '' }}>@lang('theme_timeglobalshipping::view.post')</option>
                        @endif
                    </select>
                    <input
                        type="text"
                    ...
                    @if (check_module('pages'))
                        <div class="form-control-choose-type form-control-page {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'page') ? '' : 'd-none' }}">
                            <select
                                ...
                                data-title="page"
                                data-type="array"
                                data-placeholder="@lang('theme_timeglobalshipping::view.choose_page')"
                            >
                    ...
                    @if (check_module('blog'))
                        <div class="form-control-choose-type form-control-category {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'category') ? '' : 'd-none' }}">
                            <select
                                ...
                                data-title="category"
                                data-type="array"
                                data-placeholder="@lang('theme_timeglobalshipping::view.choose_category')"
                            >
                                @if (isset($id) && isset($data['categories']) && is_array($data['categories']))
                        ...
                        <div class="form-control-choose-type form-control-post {{ (isset($data['section_url']) && isset($data['section_url']['type']) && $data['section_url']['type'] == 'post') ? '' : 'd-none' }}">
                            <select
                                ...
                                data-title="post"
                                data-type="array"
                                data-placeholder="@lang('theme_timeglobalshipping::view.choose_post')"
                            >
                                @if (isset($id) && isset($data['categories']) && is_array($data['categories']))
