<div class="hero">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_timeglobalshipping::view.section_title') </label>
        <div class="col-md-8">
    ...
    <!--begin::Input image -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_timeglobalshipping::view.background_image') </label>
        <div class="col-md-8">


            @if(isset($model))
                <x-media-library-collection data-title="image" data-type="image" max-items="1" name="image" :model="$model" collection="image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @else
                <x-media-library-attachment data-title="image" data-type="image" name="image" rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp"/>
            @endif
