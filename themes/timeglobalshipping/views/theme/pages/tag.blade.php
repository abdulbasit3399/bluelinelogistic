...
@section('page-title', \Str::title(trim($tag['name'])))

@section('page-description', trim($tag['description']))


@section('before-content')

    {{-- begin::cover --}}
    {{-- @include('theme.components.tag.cover') --}}
    {{-- end::cover --}}
...
<div class="bd-main mt-5 mb-5">
    <header class="content-only title-outer">
        ...
        <div xmlns:v="http://rdf.data-vocabulary.org/#" class="bdaia-crumb-container">
            ...
            <span class="current"> {{ \Str::title($tag['name']) }} </span>
        </div>
