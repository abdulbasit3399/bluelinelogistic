...
@section('page-title', \Str::title(trim($author['name'])))


@section('before-content')

    {{-- begin::cover --}}
    {{-- @include('theme.components.author.cover') --}}
    {{-- end::cover --}}
    ...
    <header class="content-only title-outer">
        ...
        <div xmlns:v="http://rdf.data-vocabulary.org/#" class="bdaia-crumb-container">
            <span typeof="v:Breadcrumb">
                <a rel="v:url" property="v:title" class="crumbs-home" href="{{ fr_route('home') }}">Home</a>
            </span>
            ...
            <span class="current"> {{ \Str::title($author['name']) }} </span>
        </div>
        ...
        <div class="articles-box-container-wrapper">
                                ...
                                <div class="article-thumb kolyoum-blocks-large">
                                    ...
                                    <a href="{{ fr_route('post-page', ['slug' => $post['slug']]) }}" title="{{ $post['title'] }}">
                                        <img 
                                            width="406"
                                            height="233"
                                            src="{{ $post->getFirstMediaUrl('featured_image') ? $post->getFirstMediaUrl('featured_image') : asset('assets/lte/media/avatars/blank.png') }}"
            ...
            {{-- <div class="articles-box-load-more">
                ...
                <a 
                    ...
                    data-q="{'tag_name':'bd-recipes','cat':13,'lazy_load_term_meta':true,'posts_per_page':12,'order':'DESC'}"
                    data-max-num="2"
                    data-latest="12"
                    data-page="1"
                    data-count="15"
