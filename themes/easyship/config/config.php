...
$dir_images = 'theme_easyship_images';
...
return [
    ...
    'posts_order' => [
        'latest' => __('theme_easyship::view.latest'),
        'most_commented' => __('theme_easyship::view.most_commented'),
        'random' => __('theme_easyship::view.random'),
    ],

    'image_place' => [
        'start' => __('theme_easyship::view.start'),
        'end' => __('theme_easyship::view.end'),
    ],

    'ad_types' => [
        'html' => __('theme_easyship::view.html'),
        'image' => __('theme_easyship::view.image'),
        'category' => __('theme_easyship::view.category'),
        'post' => __('theme_easyship::view.post'),
        'tag' => __('theme_easyship::view.tag'),
    ],
    
    'container_width' => [
        'full_width' => __('theme_easyship::view.full_width'),
        'half_width' => __('theme_flextock::view.half_width'),
        'two_thirds' => __('theme_easyship::view.two_thirds'),
        'one_third' => __('theme_easyship::view.one_third'),
    ],


    'theme_setting' => [
        'homepage' => [ // tab
            'name' => __('theme_easyship::view.theme_settings.homepage'),
            'sortable' => true,
            'sections' => [
                'hero' => [
                    'name' => __('theme_easyship::view.hero'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'headline' => [
                    'name' => __('theme_easyship::view.headline'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'info' => [
                    'name' => __('theme_easyship::view.info'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'business' => [
                    'name' => __('theme_easyship::view.business'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'goodhands' => [
                    'name' => __('theme_easyship::view.goodhands'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
                ...
                'start_shipping' => [
                    'name' => __('theme_easyship::view.startshipping'),
                    'validation' => [
                        'rules' => [],
                        'messages' => [],
                        'attributes' => [],
        ...
        'header' => [ // tab
            'name' => __('theme_easyship::view.theme_settings.header'),
            'sortable' => false,
            'sections' => [
                'header' => [
                    'validation' => [
        ...
        'footer' => [ // tab
            'name' => __('theme_easyship::view.theme_settings.footer'),
            'sections' => [
                'footer' => [
                    'validation' => [
                        'rules' => [
        ...
        'styling' => [ // tab
            'name' => __('theme_easyship::view.theme_settings.styling'),
            'sections' => [
                'styling' => [
                    'validation' => [
                        'rules' => [
        ...
        // 'demos' => [ // tab
        //     'name' => __('theme_easyship::view.theme_settings.demos'),
        //     'sections' => [
        //         'demos' => [
        //             'validation' => [
        //                 'rules' => [
        ...
        'additional_css' => [ // tab
            'name' => __('theme_easyship::view.theme_settings.additional_css'),
            'sections' => [
                'additional_css' => [
                    'validation' => [
                        'rules' => [
        ...
        'import_demo' => [ // tab
            'name' => __('theme_easyship::view.theme_settings.import_demo'),
            'sections' => [
                'import_demo' => [
                    'validation' => [
                        'rules' => [
