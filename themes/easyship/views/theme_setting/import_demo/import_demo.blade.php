<div class="demos-setting">
    ...
    <div class="setting-box">
        <div style="display: flex;justify-content: space-between;">
            <h4 class="setting-box-label fw-bold fs-3">@lang('theme_easyship::view.easyship_demo')</h4>
            <h4 class="fw-bold fs-3">
                <div class="mb-0 text-right form-group">
                    <button type="button" id="confirm-import" class="btn btn-sm btn-primary">@lang('theme_easyship::view.import_now')</button>
                </div>
            </h4>
        </div>

        <div class="message  message--warning">
            <p>@lang('theme_easyship::view.import_note')</p>
        </div>
        ...
        <div class="input-group radio-images" style="display: flex;justify-content: center;">
            <div class="form-check-label bg-white border p3">
                <img  class="mb-1" style="max-width: 373px;" src="{{ asset('assets/custom/images/settings/demos/easyship.jpg') }}"><br>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title h6">@lang('theme_easyship::view.import_note')</h4>
                </div>
