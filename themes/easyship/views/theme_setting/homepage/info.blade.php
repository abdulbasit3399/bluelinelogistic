...
<div class="info">
    ...
    <div class="row mb-6">
        <label class="col-md-4 fw-bold required fs-6 d-inline-flex align-items-center"> @lang('theme_shipito::view.section_title') </label>
        <div class="col-md-8">
    ...
    <!--begin::section Image -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 required d-inline-flex align-items-center"> @lang('theme_shipito::view.image_place') </label>
        <div class="col-md-8">
            <select
                class="form-control"
                ...
                name="image_place"
            >
                @foreach(config('theme_shipito.image_place') as $key => $name)
