<div class="hero">
    ...
    <!--begin::row section subtitle 1 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_easyship::view.section_subtitle1') </label>
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_subtitle1">
                    ...
                    <input
                        type="text"
                        name="section_subtitle1[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['section_subtitle1']) && isset($data['section_subtitle1'][app()->getLocale()]) ? $data['section_subtitle1'][app()->getLocale()] : '' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="section_subtitle1[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['section_subtitle1']) && isset($data['section_subtitle1'][$locale['code']]) ? $data['section_subtitle1'][$locale['code']] : '' }}"
                        >
                    @endforeach
                </div>
    ...
    <!--end::row section subtitle 1 -->

    <!--begin::row section subtitle 2 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_easyship::view.section_subtitle2') </label>
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_subtitle2">
                    ...
                    <input
                        type="text"
                        name="section_subtitle2[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['section_subtitle2']) && isset($data['section_subtitle2'][app()->getLocale()]) ? $data['section_subtitle2'][app()->getLocale()] : '' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="section_subtitle2[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['section_subtitle2']) && isset($data['section_subtitle2'][$locale['code']]) ? $data['section_subtitle2'][$locale['code']] : '' }}"
                        >
                    @endforeach
                </div>
    ...
    <!--end::row section subtitle 2 -->

    <!--begin::row section subtitle 3 -->
    <div class="row mb-6">
        <label class="col-md-4 fw-bold fs-6 d-inline-flex align-items-center"> @lang('theme_easyship::view.section_subtitle3') </label>
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_subtitle3">
                    ...
                    <input
                        type="text"
                        name="section_subtitle3[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['section_subtitle3']) && isset($data['section_subtitle3'][app()->getLocale()]) ? $data['section_subtitle3'][app()->getLocale()] : '' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="section_subtitle3[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['section_subtitle3']) && isset($data['section_subtitle3'][$locale['code']]) ? $data['section_subtitle3'][$locale['code']] : '' }}"
                        >
                    @endforeach
                </div>
        </div>
    </div>
    <!--end::row section subtitle 3 -->
