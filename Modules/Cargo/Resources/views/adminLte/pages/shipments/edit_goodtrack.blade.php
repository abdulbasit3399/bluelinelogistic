...
<div class="card">
    <div class="card-header">
        <div class="row">
        <h3 class="pt-3 bl">Edit Goods Tracking</h3>
        ...
        <div class="card-body ">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" value="{{ old('Shipment.code', isset($model) ? $model->code : '') }}" placeholder="Tracking no." name="code" required class="form-control @error('Shipment.code') is-invalid @enderror" />
                    @error('Shipment.code')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
