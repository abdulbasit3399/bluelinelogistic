        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <!--end::Filter-->
                    ...
                    @if(auth()->user()->can('export-table-drivers') || $user_role == $admin || $user_role == $branch )
                    ...
                    <!--begin::Add user-->
                    @if(auth()->user()->can('create-drivers') || $user_role == $admin || $user_role == $branch )
                        <a href="{{ fr_route('drivers.create') }}" class="btn btn-primary m-1">{{ __('cargo::view.add_driver') }}</a>
                    @endif
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
                ...
                @include('adminLte.components.modules.datatable.columns.checkbox-actions', [
                    ...
                    'url' => fr_route('drivers.multi-destroy'),
                    'callback' => 'reload-table',
                    'model_name' => __('cargo::view.selected_drivers')
                ])
                <!--end::Group actions-->
