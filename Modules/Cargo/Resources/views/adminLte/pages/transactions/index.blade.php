...
@section('pageTitle')
    {{ __('cargo::view.transactions_list') }}
@endsection
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex flex-wrap align-items-center" id="{{ $table_id }}_custom_filter">
                    ...
                    <!--begin::Add user-->
                    @if(auth()->user()->can('create-transactions') || $user_role == $admin || $user_role == $branch )
                        <a href="{{ fr_route('transactions.create') }}" class="btn btn-primary m-1">{{ __('cargo::view.add_transaction') }}</a>
                    @endif
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
