    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div>
            ...
            <form id="kt_account_profile_details_form" class="form"
                action="{{ fr_route('branches.update', ['branch' => $model->id]) }}" method="post"
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-6 fv-row">
                            ...
                            <!--end::Label-->
                            <div class="input-group mb-4">
                                <input type="hidden" type="text" name="responsible_name" class="form-control form-control-lg @error('responsible_name') is-invalid @enderror" placeholder="{{ __('cargo::view.table.owner_name') }}" value="{{ old('responsible_name', isset($model) ? $model->responsible_name : '') }}" />
                        ...
                        <div class="col-lg-6 fv-row">
                            ...
                            <!--end::Label-->
                            <div class="input-group mb-4">
                                <input  type="hidden" type="text" name="responsible_mobile" class="form-control form-control-lg @error('responsible_mobile') is-invalid @enderror" placeholder="{{ __('cargo::view.table.owner_phone') }}" value="{{ old('responsible_mobile', isset($model) ? $model->responsible_mobile : '') }}" />
