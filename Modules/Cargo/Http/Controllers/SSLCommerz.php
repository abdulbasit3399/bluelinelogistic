...
class SSLCommerz
{
    ...
    public function __construct($shipment)
    {
        ...
        $sslcommerz_payment  = json_decode($paymentSettings['sslcommerz_payment'], true);
        ...
        //     if(Session::get('payment_type') == 'cart_payment' || Session::get('payment_type') == 'wallet_payment'){
                ...
                if($sslcommerz_payment['sslcommerz_sandbox'] == 1){
                ...
                $this->store_id = $sslcommerz_payment['SSLCZ_STORE_ID'];
                $this->store_pass = $sslcommerz_payment['SSLCZ_STORE_PASSWD'];
            // }
