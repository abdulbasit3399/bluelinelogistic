...
class VaultDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->filterColumn('Shipment', function($query, $keyword) {
                $query->where('vault_number', 'LIKE', "%$keyword%");
            })
            ->orderColumn('Shipment ', function ($query, $order) {
                $query->orderBy('vault_number', $order);
            })
            ...
            // })
            ->editColumn('vault_username', function (Shipment $model) {
                return $model->vault_username;
            })
