    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('blog::view.create_new_post') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div>
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" action="{{ fr_route('posts.store') }}" method="post" enctype="multipart/form-data">
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    @include('blog::adminLte.pages.posts.form', ['typeForm' => 'create'])
                </div>
                <!--end::Card body-->
                <!--begin::Actions-->
