...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div>
            <!--begin::Form-->
            <form class="form" action="{{ fr_route('categories.update', ['id' => $model->id]) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    @include('blog::adminLte.pages.categories.form', ['typeForm' => 'edit', 'translate' => true])
                </div>
                <!--end::Card body-->
                <!--begin::Actions-->
