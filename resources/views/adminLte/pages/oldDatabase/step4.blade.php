    ...
    <div id="wizard">
        ...
        <section>
            <div class="form-row">
                ...
                <div class="tooltip"> 
                    All you need to do now is <strong>hit the 'Import Old Database' button</strong>. The auto installer will run a sql file, will do all the tiresome works and set up your application automatically.    
                </div>
            </div>
            ...
            <div class="actions">
                <ul>
                    ...
                    <li><a href="{{ route('import_sql') }}" class="next" onclick="showLoder()">Import Old Database</a></li>
                </ul>
            </div>
        </section>
    </div>
